      ...
      return {
        ...
        template: [
          `<div class="col-md-3 form-group" ng-class="{ 'has-error': form.minutes.$touched && form.minutes.$invalid}">
            ...
            <input ng-if="event.event.minutes" type="number" class="form-control minutes" name="minutes" placeholder="{{event.event.minutes}} minutes" ng-model="event.minutes" required="required">
